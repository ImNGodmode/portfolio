  ...
  return (
    <div>
        <div className='summaryContainer'>
            <h3>Summary</h3>
            <p>
            A self-starting tech-professional that constantly formulates, refines, and implements ways to simplify and optimize workflow. Comfortable operating independently, but thrives as part of or leading a group, having over 5 years of management experience across multiple fields. A team player who leads by example doing what is necessary to get the job done correctly.
            </p>
        </div>
        ...
        <div className='educationContainer'>
            <h3>Education</h3>
            <p><span>Per Scholas</span> Software Engineering Cincinnati, Oh <br/>	
            Graduation  November/2022  <br/>       
            <span>West Virginia University</span> Industrial Engineering Morgantown, Wv	<br/>
            Completed 90+ credits January 2014-December2014 <br/>
            <span>West Virginia University</span> Mechanical/Aerospace Engineering Morgantown, Wv<br/>
            Completed 75+ credits August 2007- May2012 <br/>
            </p>
        </div>
