  ...
  return (
    ...
    <div className='featureProject1Container'>
        ...
        <div className='descriptionBox'>
          ...
          <p>
            This project is a platform for trainers to interact with clients and log progress for lifting programs and macro nutrition. This application features user authentication with two log in tiers. The higher tier is for coaches. It allows the user to see their information as well as all trainee information and make updates to all information. The second is for trainees. On this tier the user can only see and update their own information. They can also see updates made to their log by their coach. 
          </p>
