    ...
    <div className='content'>
      <div className='about'>
        <div className='introContainer'>
          ...
          <h1>About Me</h1>
          <p>
              Hello, and thank you for taking the time to visit my portfolio page. My name is Blake James and I am a tech-profesional in central Kentucky. I have loved computers and gaming since I was young. I have worked with computers at a hobbiest level since High School. I built my own desktop, and have helped many others in building their personal machines. In 2022, I completed a full-stack software engineering boot camp with Per Scholas. Since completing this program, I have moved from working more on the hardware side of computers to building software and web applications. When I am not at work, or looking for new opportunities to utalize my development skills I am often sitting at my desk trying to expand my knowledge, and find new and interesting things to add to my applications. I am passionate about creating user focused applications, programs that leverage technology to simplify life, and make the users day to day life easier.  </p>
        </div>
        <div>
