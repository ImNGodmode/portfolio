    ...
    <div className='content'>
        <div className='featureProject1Container'>
            ...
            <div className='descriptionBox'>
              ...
              <p>
                This project is a moch e-commerce site for selling video games. It utalizes an API to access video game information and display it in a storefront. The project features user authentication (see top left picture) so users can log in and place games in their cart for purchase later. Each game also has a more information screen for a more in depth description of the game. The application is responsive to screen size at 3 different increments. Two places I would like to expand on this projet are the cart and pagination. Currently the cart is not connected to a payment system like stripe. When you click on check out your cart is cleared but there isn't a transaction. Also the main landing page of the application brings up the first set of games from the api but there is no option to go further by ether continuing to scroll down or going to the next page. I would like to add this feature for browsing games. 
              </p>
